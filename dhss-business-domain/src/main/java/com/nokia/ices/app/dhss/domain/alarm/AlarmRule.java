...
public class AlarmRule implements Serializable {
	...
	private String statusServiceAlarmNumber;

	private String statusServiceUniqueIdentifier;
	...
	public String getStatusServiceAlarmNumber() {
		return statusServiceAlarmNumber;
	}

	public void setStatusServiceAlarmNumber(String statusServiceAlarmNumber) {
		this.statusServiceAlarmNumber = statusServiceAlarmNumber;
	}

	public String getStatusServiceUniqueIdentifier() {
		return statusServiceUniqueIdentifier;
	}

	public void setStatusServiceUniqueIdentifier(String statusServiceUniqueIdentifier) {
		this.statusServiceUniqueIdentifier = statusServiceUniqueIdentifier;
	}
