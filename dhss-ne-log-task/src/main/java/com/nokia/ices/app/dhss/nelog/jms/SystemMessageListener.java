...
public class SystemMessageListener {
	...
	private final static Logger logger = LoggerFactory.getLogger(SystemMessageListener.class);
	private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private static final String scriptName = "SSH_DHLR_NE_LOG";
	private final static String destQName = "neLogListener";
    ...
    /**
     * 监听系统管理平台，是否发送请求执行定时任务
     * @param message
     */
	@JmsListener(destination =destQName, containerFactory = "jmsContainerFactory")
