package com.nokia.ices.app.dhss.jdbc;
...
public class JdbcDataSourceSettings {
    ...
    @Bean
    @ConfigurationProperties(prefix="spring.jdbc.pgw.datasource")
    public DataSource pgwDataSource() {
        logger.debug("######################");
        logger.debug("#                    #");
        logger.debug("# init pgw Database  #");
        logger.debug("#                    #");
        logger.debug("######################"); 
        return DataSourceBuilder.create().build();
    }
    ...
    @Bean(name="jdbcTemplatePgw")
    public JdbcTemplate jdbcTemplatePgw(){
        return new JdbcTemplate(pgwDataSource());
    }
