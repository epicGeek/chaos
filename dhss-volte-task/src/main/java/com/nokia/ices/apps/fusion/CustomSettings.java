...
public class CustomSettings implements BeanClassLoaderAware {
	...
	private static String updateCounterFlagSql;
	...
	public static String getUpdateCounterFlagSql() {
		return updateCounterFlagSql;
	}


	public static void setUpdateCounterFlagSql(String updateCounterFlagSql) {
		CustomSettings.updateCounterFlagSql = updateCounterFlagSql;
	}
