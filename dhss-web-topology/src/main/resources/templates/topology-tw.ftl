    ...
    <div class="panel panel-default">
        <div class="panel-heading"><span class="eNodeBName" style="width: auto"></span>基本信息
            <div class="pull-right">
            	...
            	<a role="button" tabindex="0" class="btn btn-default btn-xs one-click">连接测试</a>
            	<!-- <a role="button" tabindex="0" class="btn btn-default btn-xs one-click">终端</a> -->
                <a role="button" tabindex="0" class="btn btn-default btn-xs closePanel">關閉</a>
            </div>
        </div>
        <div class="panel-body" style="padding: 5px"  style="margin:0px;"  >
            ...
            <ul class="" id="topKpi">
                ...
                <li>
                    <span>硬體版本：</span><span class="idsVersion"> </span>
                </li>
                <li>
                    <span class="kpiname">軟體版本：</span><span class="kpinum swVersion"> </span>
                </li>
                <li  style="display:none;">
                    <span class="kpiname">狀態：</span>
        ...
        <div class="panel-body" style="padding: 5px"  style="margin:0px;"  >
            ...
            <div id='result3Wrapa' class="customScrollbar" style="padding:0 15px;overflow:scroll;overflow-y:hidden;">
            	<ul class="">
	                ...
	                <li>
	                    <span class="kpiname">軟體版本：</span><span class="swVersion"> </span>
	                </li>
	                <li  style="display:none;">
	                    <span class="kpiname">狀態：</span>
	                ...
	                <li>
	                    <span class="kpiname">描述：</span><span class="remarks"></span>
	                </li>
	            </ul>
