...
public class ProjectProperties implements BeanClassLoaderAware {
	...
	private static String system_manage_url;
	
	

    public static String getSystem_manage_url() {
		return system_manage_url;
	}
	public static void setSystem_manage_url(String system_manage_url) {
		ProjectProperties.system_manage_url = system_manage_url;
	}
    ...
    private static String luaTestDestQ;
    private static String luaTestSrcQ;
    private static Integer luaTestMessageCode;
    private static String luaTestLogPath;
    
    
    private static String HOMECOUNT;
    public static String getHOMECOUNT() {
		return HOMECOUNT;
	}
	public static void setHOMECOUNT(String hOMECOUNT) {
		HOMECOUNT = hOMECOUNT;
	}
	...
	public static String getLuaTestDestQ() {
		return luaTestDestQ;
	}
	public static void setLuaTestDestQ(String luaTestDestQ) {
		ProjectProperties.luaTestDestQ = luaTestDestQ;
	}
	public static String getLuaTestSrcQ() {
		return luaTestSrcQ;
	}
	public static void setLuaTestSrcQ(String luaTestSrcQ) {
		ProjectProperties.luaTestSrcQ = luaTestSrcQ;
	}
	public static String getLuaTestLogPath() {
		return luaTestLogPath;
	}
	public static void setLuaTestLogPath(String luaTestLogPath) {
		ProjectProperties.luaTestLogPath = luaTestLogPath;
	}
	public static Integer getLuaTestMessageCode() {
		return luaTestMessageCode;
	}
	public static void setLuaTestMessageCode(Integer luaTestMessageCode) {
		ProjectProperties.luaTestMessageCode = luaTestMessageCode;
	}
